...
<div class="flex items-center justify-center min-h-screen bg-gray-100">
    ...
    <form use:form action="" on:submit|preventDefault={handleSubmit}>
        ...
        <button class="px-6 py-2 mt-1 text-white bg-green-500 rounded-lg hover:bg-green-700"
                on:click|preventDefault={signup}>Sign up</button>

        <p class="text-center mt-2">Already have an account? <a href="/login" class="text-green-600 font-medium underline">Login</a></p>
    </form>
    </div>
</div>