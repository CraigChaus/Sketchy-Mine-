...
<div
  class="min-w-screen h-screen animated fadeIn faster fixed left-0 top-0 flex
  ...
  >
    ...
    <div class="">
      ...
      <div class="items-center">
        <input
          class="bg-gray-200 border-green-400 rounded-md w-full h-12 p-2"
          type="text"
          bind:value={warning}
        />
      </div>
      ...
      <div class="p-3 mt-2 text-center space-x-4 md:block">
        <button
          class="mb-2 md:mb-0 bg-white px-5 py-2 text-sm font-medium tracking-wider border
                                text-gray-600 rounded-full hover:bg-gray-100 transition-all"
          on:click={cancel}
          >Cancel
        </button>
        <button
          class="mb-2 md:mb-0 bg-blue-500 border border-blue-500 px-5 py-2 text-sm font-medium
